...
raw.file <- read.csv(paste("cvd_cancer_merged_", version.date, ".csv", sep=""), fileEncoding = 'UTF-8-BOM')
...
Loop through each row and generate mortality/incidence sims based on mean and standard error for each subgroup. 
