---
title: "cost_change_functions_documentation"
author: "Fred Cudhea"
...
```{r sim_intake_means, eval=FALSE, echo=TRUE}
...
```{r correction_factors, eval=FALSE, echo=TRUE}
...
```{r apply_corrections, eval=FALSE, echo=TRUE}
...
```{r sim_impact_factors, eval=FALSE, echo=TRUE}
...
```{r calc_impact, eval=FALSE, echo=TRUE}
...
```{r calc_sub_impact, eval=FALSE, echo=TRUE}
...
```{r calc_total_impact, eval=FALSE, echo=TRUE}
...
```{r calc_current+counterfactual_impact, eval=FALSE, echo=TRUE}
...
```{r total_delta, eval=FALSE, echo=TRUE}
...
11. substitution.sims.consumed = impact from substitution of calories needed to maintain energy going from current to counterfactual for dietary factor of interest, but just for the consumed part of the dietary factor
12. combined.impact.sims.consumed = combined impact of dietary factor shift and corresponding substitution impact (impact.sim.unconsumed+substitution.sims.unconsumed), but just for the unconsumed part of the dietary factor
...
26. combined.impact.sims.wasted = combined impact of dietary factor shift and corresponding substitution impact (impact.sim.wasted+substitution.sims.wasted), but just for the wated part of the dietary factor
...
```{r return_list, eval=FALSE, echo=TRUE}
...
```{r get.percapita.sims, eval=FALSE, echo=TRUE}
...
1. delta.sims.summary = summary stats for change in amount of food produced for dietary factor of interest
...
```{r get.summary.stats, eval=FALSE, echo=TRUE}
...
```{r get.summary.stats.simple, eval=FALSE, echo=TRUE}
...
```{r get.summary.stats.by.strata.start, eval=FALSE, echo=TRUE}
...
```{r get.summary.stats.by.strata.setup, eval=FALSE, echo=TRUE}
...
```{r sum_by_strata, eval=FALSE, echo=TRUE}
...
```{r sum_pop_strata, eval=FALSE, echo=TRUE}
...
```{r percapita, eval=FALSE, echo=TRUE}
...
```{r reshape_and_summarize, eval=FALSE, echo=TRUE}
...
```{r reshape_and_summarize_percapita, eval=FALSE, echo=TRUE}
...
```{r return_results, eval=FALSE, echo=TRUE}
